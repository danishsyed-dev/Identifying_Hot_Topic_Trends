...
urlpatterns = [
    ...
    re_path(r'^Predict_Identifying_Hot_Topic_Trends/$', remoteuser.Predict_Identifying_Hot_Topic_Trends, name="Predict_Identifying_Hot_Topic_Trends"),
    ...
    re_path(r'^View_Predicted_Identifying_Hot_Topic_Trends_Ratio/$', serviceprovider.View_Predicted_Identifying_Hot_Topic_Trends_Ratio, name="View_Predicted_Identifying_Hot_Topic_Trends_Ratio"),
    re_path(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    re_path(r'^View_Predicted_Identifying_Hot_Topic_Trends/$', serviceprovider.View_Predicted_Identifying_Hot_Topic_Trends, name="View_Predicted_Identifying_Hot_Topic_Trends"),
